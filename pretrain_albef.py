...
class ALBEF(nn.Module):
    ...
    def forward(self, text, label, alpha=0):
        ...
        with torch.no_grad():
            ...
            sim_t2l_m = text_feat_m @ text_feat_all / self.temp
            sim_l2t_m = label_feat_m @ label_feat_all / self.temp
